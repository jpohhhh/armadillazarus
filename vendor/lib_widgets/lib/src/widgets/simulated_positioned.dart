...
class SimulatedDragStartDetails extends DragStartDetails {
  ...
  SimulatedDragStartDetails({required Offset globalPosition})
...
class _SimulatedPositionedState extends State<SimulatedPositioned>
  ...
  late _SimAnimationController _positionAnimation;
  late _SimAnimationController _sizeAnimation;
  ...
  void _endDrag(DragEndDetails details) {
    setState(() {
      ...
      widget.onDragEnd?.call(new SimulatedDragEndDetails(
        ...
        primaryVelocity: details.primaryVelocity ?? 0.0,
