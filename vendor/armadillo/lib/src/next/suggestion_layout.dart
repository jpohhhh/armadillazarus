...
class SuggestionLayout {
  ...
  double _suggestionHeight = _kSmallSuggestionHeight;
  // ARMADILLAZARUS(parity): was kSuggestionWidth which caused layout()
  // to early-return on first call, never building _suggestionText.
  double _suggestionWidth = -1;
  Widget? _suggestionText;

  /// Constructor.
  SuggestionLayout({required Suggestion suggestion})
