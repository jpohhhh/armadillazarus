...
class SplashSuggestion extends ExpansionBehavior {
  ...
  late RK4SpringSimulation _sweepSimulation;
  late RK4SpringSimulation _clearSimulation;
  bool _notified = false;

  /// Constructor.
  SplashSuggestion({
    required this.suggestion,
    required this.suggestionInitialGlobalBounds,
  ...
  bool handleTick(double elapsedSeconds) {
    ...
    if (!_sweepIsDone) {
      ...
      if (onSuggestionExpanded != null && !_notified) {
        onSuggestionExpanded?.call(suggestion);
        _notified = true;
      }
