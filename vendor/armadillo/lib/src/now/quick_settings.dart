...
// ARMADILLAZARUS(parity): Original used intl DateFormat. Replaced inline.
...
const String _kAirplaneModeInactiveGrey600 =
    'packages/armadillo/lib/res/ic_airplanemode_inactive_grey600.png';
const String _kAirplaneModeActiveBlack =
    'packages/armadillo/lib/res/ic_airplanemode_active_black.png';
const String _kDoNoDisturbOffGrey600 =
    'packages/armadillo/lib/res/ic_do_not_disturb_off_grey600.png';
const String _kDoNoDisturbOnBlack =
    'packages/armadillo/lib/res/ic_do_not_disturb_on_black.png';
const String _kScreenLockRotationBlack =
    'packages/armadillo/lib/res/ic_screen_lock_rotation_black.png';
const String _kScreenRotationBlack =
    'packages/armadillo/lib/res/ic_screen_rotation_black.png';
const String _kBrightnessHighGrey600 =
    'packages/armadillo/lib/res/ic_brightness_high_grey600.png';
const String _kVolumeUpGrey600 =
    'packages/armadillo/lib/res/ic_volume_up_grey600.png';
              ...
              builder: (
                ...
                ContextModel contextModel,
                  ...
                  contextModel.buildTimestamp != null
                      ? new Text(
                          'Built ${contextModel.buildTimestamp}',
                          textAlign: TextAlign.center,
                          style: new TextStyle(
                            fontFamily: 'RobotoMono',
                            color: Colors.grey[600],
