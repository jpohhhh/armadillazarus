...
class RenderStoryListBody extends RenderListBody {
  ...
  void paint(PaintingContext context, Offset offset) {
    ...
    final StoryListBodyParentData mostFocusedChildParentData =
        lastChild.parentData as StoryListBodyParentData;
  ...
  void _paintChild(
    ...
    final StoryListBodyParentData childParentData =
        child!.parentData as StoryListBodyParentData;
  ...
  bool hitTestChildren(BoxHitTestResult result, {required Offset position}) {
    ...
    if (children.isNotEmpty) {
      ...
      final StoryListBodyParentData mostFocusedChildParentData =
          mostFocusedChild.parentData as StoryListBodyParentData;
  ...
  List<RenderBox> get _childrenSortedByFocusProgress {
    ...
    children.sort((RenderBox child1, RenderBox child2) {
      final StoryListBodyParentData child1ParentData =
          child1.parentData as StoryListBodyParentData;
      final StoryListBodyParentData child2ParentData =
          child2.parentData as StoryListBodyParentData;
